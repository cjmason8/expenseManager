...
public class DonationController extends BaseController<Donation, DonationDto> {
	...
	@PutMapping(value = "/donations/{id}", produces = "application/json", consumes = "application/json", headers = "Accept=application/json")
	...
	@DeleteMapping(value = "/donations/{id}", produces = "application/json", headers = "Accept=application/json")
	...
	@PostMapping(value = "/donations/search", produces = "application/json", consumes = "application/json", headers = "Accept=application/json")
