...
public class RefDataController extends BaseController<RefData, RefDataDto> {
	...
	@RequestMapping(value = "/refDatas", method = RequestMethod.POST, produces = "application/json", consumes = "application/json", headers = "Accept=application/json")
	...
	@RequestMapping(value = "/refDatas/{id}", method = RequestMethod.PUT, produces = "application/json", consumes = "application/json", headers = "Accept=application/json")
	...
	@RequestMapping(value = "/refDatas/{id}", method = RequestMethod.DELETE, produces = "application/json", headers = "Accept=application/json")
	...
	@RequestMapping(value = "/refDatas/search", method = RequestMethod.POST, produces = "application/json", consumes = "application/json", headers = "Accept=application/json")
