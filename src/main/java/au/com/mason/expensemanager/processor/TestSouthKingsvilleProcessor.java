...
public class TestSouthKingsvilleProcessor {
	...
	public static void main(String[] args) {
		try {
			...
			jakarta.activation.DataHandler dh = new jakarta.activation.DataHandler(new jakarta.activation.DataSource() {
			...
			System.out
				.println("  - Starts with APPLICATION/PDF: " + testPart.getContentType().startsWith("APPLICATION/PDF"));
